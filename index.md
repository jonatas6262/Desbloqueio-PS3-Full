<a href="https://jonatas6262.github.io/Desbloqueio-PS3/">Inicío</a><span style="color:#ffffff"> | </span><a href="https://jonatas6262.github.io/Ativar-HAN/">Ativar HAN</a><span style="color:#ffffff"> | </span><a href="https://jonatas6262.github.io/Ativar-DEBUG/">Ativar DEBUG</a><span style="color:#ffffff"> | </span><a href="https://jonatas6262.github.io/Instalar-HAN/">Instalar HAN</a><span style="color:#ffffff"> | </span><a href="https://jonatas6262.github.io/HAN-ACT-IDPS-Dumper/">ACT/IDPS Dumper</a><span style="color:#ffffff"> | </span><a href="https://jonatas6262.github.io/HAN-ACT-RIF-Copier/">ACT/RIF Copier</a><span style="color:#ffffff"> | </span><a href="https://jonatas6262.github.io/Desbloqueio-PS3-Full/">HAN FULL</a>

<html>
<head>
<script src="ps3HAN_v100.js"></script>
<meta charset="UTF-8"> 
<title>PS3 HAN Installer</title>
<p>Instalar Esse Primeiro, Menu HAN Nativo - <a href="https://archive.org/download/han_20210725_202107/HAN.p3t">PS3HAN</a></p><p>Instalar Esse Segundo, Menu HAN Nativo -&nbsp;<a href="https://archive.org/download/ps-3-han/PS3HAN.p3t">HAN</a></p>
<script>
var debug=true;
...
var ps3HAN_ecdsa_key='948DA13E8CAFD5BA0E90CE434461BB327FE7E080475EAA0AD3AD4F5B6247A7FDA86DF69790196773';
...
var usb_sp='/dev_hdd0/theme/PS3HAN.p3t';
...
var vsh_ps3HAN_key_toc_481_d=0x717CA4;
...
var vsh_ps3HAN_key_toc_482_d=0x7180DC;
...
var vsh_ps3HAN_key_toc_481=0x70733C;
...
var vsh_ps3HAN_key_toc_482=0x707774;
...
var vsh_ps3HAN_key_toc_483=0x70786C;
...
var vsh_ps3HAN_key_toc_484_d=0x7181D4;
...
var vsh_ps3HAN_key_toc_484=0x70786C;
...
var vsh_ps3HAN_key_toc_485=0x70786C;
...
var vsh_ps3HAN_key_toc_486=0x707A1C;// Updated From 4.83/4.84/4.85
...
var vsh_ps3HAN_key_toc_487=0x707A1C;// Updated From 4.83/4.84/4.85
...
var vsh_ps3HAN_key_toc_488=0x707A1C;// Updated From 4.83/4.84/4.85
...
function rop_exit_HAN(suc, fail)
{
	// // operations to execute on ROP exit
	var chk="53434500";
...
function loaddex_481()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_481_d;
...
function loadcex_481()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_481;
...
function loaddex_482()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_482_d;
...
function loadcex_482()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_482;
...
function loadcex_483()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_483;
...
function loaddex_484()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_484_d;
...
function loadcex_484()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_484;
...
function loadcex_485()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_485;
...
function loadcex_486()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_486;
...
function loadcex_487()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_487;
...
function loadcex_488()
{
	...
	vsh_ps3HAN_key_toc=vsh_ps3HAN_key_toc_488;
...
function ps3chk(){
	...
	var fwVersion = ua.substring(ua.indexOf("5.0 (") + 19, ua.indexOf(") Apple"));
	var msgHFW = "ATTENTION!\n\nYour firmware version requires 4.84/4.85/4.86/4.87/4.88 HFW (Hybrid Firmware) to be installed, containing exploitable modules.";
	var msgCongrats = "Congratulations! We've detected your PlayStation 3 is running FW " + fwVersion + ", which is compatible with ps3HAN! Enjoy!";
...
//					initDEX();
				...
				default:
					//alert('Your PS3 is not on FW 4.84/4.85! Your current running FW version is ' + fwVersion + ', which is not compatible with ps3HAN 1.0. All features have been disabled');
					disable_all();
					break;
			}
			break;
...
function triggerX()
{
		...
		setTimeout(rop_exit_HAN,5000,hr+"<h1><b><font color=%22386E38%22>HAN is successfully installed</font></b></h1>","<h1><b><font color='red'>HAN Failure! Restart PS3 and retry!</font></b></h1>");
		cleanGUI();
}
</script>
</head>
	<body id="bodyId" style="background-color:#ffffff" onload="javascript:downloadHAN()">
	...
	<h3>Supports CEX 4.84/4.85/4.86/4.87/4.88 HFW Firmware</h3>
	...
	<span style="color:#0055AA"><h3>INFO: If HAN is already installed, this will act as an Enabler</font></h3><br>
	<hr></div>
	<p><button id="btnROP" type="button" onclick="initROP(true);" autofocus>Initialize HAN installer</button> | Auto-Close Browser <input type="checkbox" id="auto_close" name="aclose" checked="checked" onclick="autoclose();"/><span id="dex_txt" style="visibility:hidden"> | DEX mode<input type="checkbox" id="dex" name="DEX" disabled="" onclick="dex();"/></span></p>
	<p><button id="btnTrigger" disabled="" type="button" onclick="triggerX();">Install HAN</button><span id="reset" style="visibility:hidden"> | <button id="btnReset" type="button" onclick="disable_trigger();">Reset</button></span></p>
